...
class ManufacturerSerializer(serializers.ModelSerializer):
    logo_url = serializers.SerializerMethodField()  # Добавляем поле для URL логотипа
    
    class Meta:
        model = Manufacturer
        fields = ['id', 'name', 'country', 'website', 'logo', 'logo_url']  # Добавляем logo и logo_url
...
class ComponentSerializer(serializers.ModelSerializer):
    image_url = serializers.SerializerMethodField()  # Добавляем поле для URL изображения
    ...
    class Meta:
        ...
        fields = [
            ...
            'specifications', 'in_stock', 'image', 'image_url', 'created_at'  # Добавляем image и image_url
        ]
