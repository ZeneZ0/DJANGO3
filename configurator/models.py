...
class Component(models.Model):
    ...
    component_type = models.ForeignKey(ComponentType, on_delete=models.CASCADE, verbose_name="Тип компонента")  # Внешний ключ 1
    manufacturer = models.ForeignKey(Manufacturer, on_delete=models.CASCADE, verbose_name="Производитель")  # Внешний ключ 2
